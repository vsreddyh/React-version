...
export default function HomePage (){
    ...
    const [sugesstions,setSugessions]=useState([]);
    ...
    const newpage=async(event)=>
    {
        ...
        const response=await axios.post(`en/main?term=${term}`);
            ...
            <div className="total">
                ...
                <div className="homeelements">
                    <div className="basicgrid">
                        <div className="bgridelements" onClick={newpage} value="Machine Learning">
                        ...
                        <div className="bgridelements" onClick={newpage} value="Artificial Intelligence">
                            <div className="forpic">
                        ...
                        <div className="bgridelements" onClick={newpage} value="Web Development">
                            <div className="forpic">
                        ...
                        <div className="bgridelements" onClick={newpage} value="App Development">
                            <div className="forpic">
                        ...
                        <div className="bgridelements" onClick={newpage} value="AR/VR projects">
                            <div className="forpic">
                        ...
                        <div className="bgridelements" onClick={newpage} value="Block Chain">
                            <div className="forpic">
