...
const {getdata,projectlist,image,getstudata,fetchprojdata,addbookmark,removebookmark,checkbookmark,validateurl, getDomainProjects, getprojectdata} = require('./controllers/mainpage.js')
